...
//     final String statusLabel = _getTaskTypeName(widget.taskType);
//     final Color statusColor = _getTaskChipColor(widget.taskType);
//
//     return Card(
//       elevation: 0,
//       color: Colors.white,
...
//             final name = _getTaskTypeName(type);
//             return ListTile(
//               title: Text(name),
//               trailing:
//               widget.taskType == type ? const Icon(Icons.check) : null,
//               onTap: () {
//                 if (widget.taskType != type) {
//                   _updateTaskStatus(name);
//                 } else {
